...
class MockSettingsNotifier extends SettingsNotifier {
  ...
  MockSettingsNotifier(this._testSettings, MockSharedPreferencesAsync prefs) : super(prefs) {
    state = _testSettings;
  }
}
...
class MockSessionNotifier extends SessionNotifier {
  MockSessionNotifier(MockKeyManager keyManager, MockSessionStorage sessionStorage, Settings settings) 
    : super(keyManager, sessionStorage, settings);
